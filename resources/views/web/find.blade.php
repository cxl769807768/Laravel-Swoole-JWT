...
<script>
        ...
        layui.use('layim', function(layim){
            layim.add({
                ...
                ,submit: function(group, remark, index){ //一般在此执行Ajax和WS，以通知对方
                    var data = {type:"addFriend",to_user_id:id,to_friend_group_id:group,remark:remark,uid:JSON.parse(window.localStorage.getItem('userInfo')).id}
                    parent.sendMessage(parent.ws,JSON.stringify(data))
    ...
    function createGroup() {
        layer.open({
            ...
            shade: 0.8,
            area: ['40%', '70%'],
            content: '/createGroupShow' //iframe的url
        });
    }
</script>
</body>
