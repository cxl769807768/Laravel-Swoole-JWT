...
return [
    ...
    'swoole'                   => [
        ...
        /**自定义的异步事件或异步的任务队列(此特性依赖Swoole的AsyncTask，必须先设置config/laravels.php的
         *swoole.task_worker_num。异步事件的处理能力受Task进程数影响，
         * 需合理设置task_worker_num)
         */
        ...
        // WebSocket 长连接的强制关闭逻辑(每隔 60s 检测一次所有连接，如果某个连接在 600s 内都没有发送任何数据，则关闭该连接)
